...
// process environment variables form Divio Cloud
$SECRET_KEY = getenv('SECRET_KEY') ?: 'localdev';
...
// store database information in reusable environment variables
putenv('POSTGRES_DB='.$pg_dbname);
putenv('POSTGRES_USER='.explode(':', $pg_credentials)[0]);
putenv('POSTGRES_PASSWORD='.explode(':', $pg_credentials)[1]);
putenv('POSTGRES_HOST='.$pg_host);
putenv('POSTGRES_PORT='.$pg_port);
